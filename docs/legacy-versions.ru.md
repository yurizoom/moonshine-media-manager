[← Разработка](development.ru.md) · [English](legacy-versions.md) | **Русский** · [Back to README](../README.ru.md)
...
- [Установка](getting-started.ru.md) — актуальная настройка v4
- [Конфигурация](configuration.ru.md) — полный список параметров v4
