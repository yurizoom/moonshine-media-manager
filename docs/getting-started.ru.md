[Back to README](../README.ru.md) · [English](getting-started.md) | **Русский** · [Конфигурация →](configuration.ru.md)
...
- [Конфигурация](configuration.ru.md) — диск, расширения, лимиты, авторизация, z-index слои
- [Поле MediaManagerPicker](picker-field.ru.md) — выбор файлов прямо в формах
- [API и события](api.ru.md) — AJAX-эндпоинты и события для интеграции

## See Also

- [Конфигурация](configuration.ru.md) — все параметры конфига и env-переменные
- [Поле MediaManagerPicker](picker-field.ru.md) — интеграция менеджера в формы ресурсов
- [Разработка](development.ru.md) — сборка ассетов из исходников
