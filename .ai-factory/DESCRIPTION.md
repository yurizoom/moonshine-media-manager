...
- **Тесты:** PHPUnit + Orchestra Testbench (`phpunit.xml.dist`, `tests/Unit`, `tests/Feature`): санитайзеры путей/имён, строгий whitelist расширений, SVG-sanitizer, форматтеры, JSON-контракт эндпоинтов (400 вместо 500)
