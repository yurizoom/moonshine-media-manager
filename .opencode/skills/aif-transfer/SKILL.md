...
3. Resolve and validate that target with `/aif-evolve` Step 0.1, using
   `.opencode/skills/aif-evolve/SKILL.md` or the development fallback
...
Use the current evolve workflow loaded in Step 0 from `.opencode/skills/aif-evolve/SKILL.md`
